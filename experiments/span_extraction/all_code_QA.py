...
train_data = CMRC2018('dataset/span_extraction/task3_11111_train.json')
valid_data = CMRC2018('dataset/span_extraction/task3_11111_dev.json')
test_data = CMRC2018('dataset/span_extraction/task3_11111_test.json')
